...
csv_path = f"/Volumes/CFElab/Projects/STT_Traps/{folder}/{folder}_Measured_particles_all-magnifications.csv"

# Base output directory where class-organized folders will be created
output_base = f"/Volumes/CFElab/Projects/STT_Traps/{folder}/{folder}_facebook_prediction_v1/"
