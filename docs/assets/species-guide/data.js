...
const SPECIES = [
  // ---- Radiolarians & rhizarians ----
  {
    id: "acantharia", label: "Acantharia", category: "Radiolarians & rhizarians", count: 11, hasProfile: true, isBiological: true,
  ...
  },
  {
    ...
    note: "Dark central body (the phaeodium) with a silica skeleton that varies from solid and spineless to spined, latticed, or radially striated.",
    description: "Phaeodarians are single-celled marine Rhizaria (subclass Phaeodaria) that build intricate skeletons of amorphous silica, typically enclosing a mass of dark pigmented granules called the phaeodium near the cell center — the dark body seen in every crop of this class. Skeleton shape varies enormously between genera: solid and spineless, star-shaped with short jagged spines, round with a honeycomb lattice shell, round with fine radial sunburst striations, or bearing a moderate number of long, thin, evenly spaced spines. All of these forms are labeled as one `phaeodaria` class here, regardless of which skeleton shape a given specimen shows.",
  ...
  {
    id: "diatom_chain_straight", label: "Diatom chain (straight)", category: "Diatoms", count: 696, hasProfile: true, isBiological: true,
  ...
  {
    id: "diatom_chain_spiral", label: "Diatom chain (spiral)", category: "Diatoms", count: 2234, hasProfile: true, isBiological: true,
  ...
  {
    id: "diatom_chain_spines", label: "Diatom chain (spines)", category: "Diatoms", count: 966, hasProfile: true, isBiological: true,
  ...
  // ---- Gelatinous zooplankton ----
  {
    id: "larvacean", label: "Larvacean", category: "Gelatinous zooplankton", count: 354, hasProfile: true, isBiological: true,
  ...
  {
    id: "siphonophore", label: "Siphonophore", category: "Gelatinous zooplankton", count: 37, hasProfile: true, isBiological: true,
  ...
  {
    id: "jelly", label: "Jelly", category: "Gelatinous zooplankton", count: 14, hasProfile: true, isBiological: true,
  ...
  {
    id: "ctenophore", label: "Ctenophore", category: "Gelatinous zooplankton", count: 5, hasProfile: true, isBiological: true,
  ...
  // ---- Crustaceans & other animals ----
  {
    id: "copepod", label: "Copepod", category: "Crustaceans & other animals", count: 1318, hasProfile: true, isBiological: true,
  ...
  {
    id: "chaetognath", label: "Chaetognath", category: "Crustaceans & other animals", count: 41, hasProfile: true, isBiological: true,
  ...
  {
    id: "molt", label: "Molt", category: "Crustaceans & other animals", count: 4, hasProfile: true, isBiological: false,
  ...
  {
    id: "shrimp", label: "Shrimp", category: "Crustaceans & other animals", count: 6, hasProfile: true, isBiological: true,
  ...
  // ---- Colonial algae ----
  {
    id: "phaeocystis", label: "Phaeocystis", category: "Colonial algae", count: 2365, hasProfile: true, isBiological: true,
  ...
  // ---- Marine snow, aggregates & fecal material ----
  {
    id: "aggregate_dense", label: "Aggregate (dense)", category: "Marine snow, aggregates & fecal material", count: 2795, hasProfile: true, isBiological: false,
  ...
  {
    id: "aggregate_light", label: "Aggregate (light)", category: "Marine snow, aggregates & fecal material", count: 209, hasProfile: true, isBiological: false,
  ...
  {
    id: "aggregate_string", label: "Aggregate (string)", category: "Marine snow, aggregates & fecal material", count: 665, hasProfile: true, isBiological: false,
  ...
  {
    id: "long_fecal_pellet", label: "Fecal pellet (long)", category: "Marine snow, aggregates & fecal material", count: 719, hasProfile: true, isBiological: false,
  ...
  {
    id: "short_fecal_pellet", label: "Fecal pellet (short)", category: "Marine snow, aggregates & fecal material", count: 21, hasProfile: true, isBiological: false,
  ...
  {
    id: "bubble", label: "Bubble", category: "Non-biological / imaging artifacts", count: 1498, hasProfile: true, isBiological: false,
  ...
  {
    id: "string", label: "String", category: "Non-biological / imaging artifacts", count: 329, hasProfile: true, isBiological: false,
